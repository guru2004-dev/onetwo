      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-md dark:shadow-2xl rounded-2xl p-6 flex flex-col gap-6">
          <div className="flex items-center justify-between border-b border-gray-200 dark:border-white/10 pb-4">
            <div>
              <h2 className="text-lg font-bold text-slate-900 dark:text-white">Appliance Details</h2>
              <p className="text-slate-600 dark:text-slate-400 text-sm">Input power specifications</p>
            </div>
            <button
              onClick={handleReset}
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-transparent dark:bg-transparent dark:bg-slate-900/50 border border-gray-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 transition-all outline-none"
            >
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold text-yellow-400 uppercase tracking-wider flex items-center gap-2 border-b border-gray-200 dark:border-white/10 pb-2">
              <Battery className="w-4 h-4"/> Hardware Data
            </h3>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-[13px] text-slate-700 dark:text-slate-300 mb-1">Appliance Power</label>
                <div className="flex relative">
                   <input type="number" min={0} value={devicePower} onChange={e => setDevicePower(e.target.value)} className="w-2/3 px-4 py-2.5 rounded-l-xl bg-transparent dark:bg-transparent dark:bg-slate-900/50 border border-gray-200 dark:border-white/10 border-r-0 text-slate-900 dark:text-white focus:outline-none focus:border-yellow-500 transition-all font-semibold" />
                   <select value={powerUnit} onChange={e => setPowerUnit(e.target.value)} className="w-1/3 px-2 py-2.5 rounded-r-xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-white/10 text-slate-700 dark:text-slate-300 focus:outline-none focus:border-yellow-500 transition-all">
              ...
              <div>
                <label className="block text-[13px] text-slate-700 dark:text-slate-300 mb-1">Usage (Hours per Day)</label>
            ...
            <div>
              <label className="block text-[13px] text-slate-700 dark:text-slate-300 mb-1">Electricity Rate (per kWh)</label>
              <div className="relative">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-md dark:shadow-2xl rounded-2xl p-6 h-full flex flex-col justify-center gap-4">
                  ...
                  <button
                    ...
                    className={`px-3 py-1 text-xs rounded-full border font-medium transition-all ${
                      selectedResultCurrency === c
                        ...
                        : 'bg-white dark:bg-white/5 border-gray-200 dark:border-white/10 text-slate-600 dark:text-slate-400 hover:border-yellow-400 hover:text-slate-800 dark:text-slate-800 dark:text-slate-200'
                    }`}
                  >
                    {c}
                  </button>
            ...
            {results ? (
              <>
                <div className="border border-gray-200 dark:border-white/10 bg-gradient-to-r from-yellow-900/30 to-amber-900/30 rounded-xl p-5 shadow-inner text-center">
                  <p className="text-sm text-yellow-300 font-semibold mb-1 uppercase tracking-widest">Monthly Estimated Cost</p>
                  <p className="text-5xl font-extrabold text-slate-900 dark:text-white mb-2">{disp(results.monthlyCost)}</p>
                  <div className="inline-flex bg-gray-100 dark:bg-gray-100 dark:bg-black/20 rounded-full px-4 py-1 text-sm border border-gray-100 dark:border-gray-100 dark:border-white/5">
                    <span className="text-slate-700 dark:text-slate-300">Energy Run Rate:</span>
                ...
                <div className="grid grid-cols-2 gap-3 mt-2">
                  <div className="rounded-xl border bg-gray-50 dark:bg-white dark:bg-gray-50 dark:bg-slate-800/50 border-gray-100 dark:border-gray-100 dark:border-white/5 p-4 flex flex-col items-center text-center">
                    <div className="text-[10px] font-semibold uppercase tracking-wider text-slate-600 dark:text-slate-400">Daily Cost</div>
                    <p className="font-bold text-lg text-slate-900 dark:text-white mb-1">{disp(results.dailyCost)}</p>
                    <p className="text-xs text-yellow-500/70">{results.dailyKwh.toFixed(2)} kWh</p>
                  </div>
                  <div className="rounded-xl border bg-gray-50 dark:bg-white dark:bg-gray-50 dark:bg-slate-800/50 border-gray-100 dark:border-gray-100 dark:border-white/5 p-4 flex flex-col items-center text-center">
                    <div className="text-[10px] font-semibold uppercase tracking-wider text-slate-600 dark:text-slate-400">Yearly Cost</div>
                    <p className="font-bold text-lg text-slate-900 dark:text-white mb-1">{disp(results.yearlyCost)}</p>
      ...
      {results && (
        <div className="max-w-6xl mx-auto mt-6">
          <div className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-md dark:shadow-2xl rounded-2xl p-6">
            <h3 className="text-base font-bold text-slate-900 dark:text-white mb-6">Financial Scale of Operation</h3>
