    ...
    <div>
      ...
      <div className="relative mb-3">
        ...
        <input
          ...
          max={max}
          step={step}
          className={`w-full py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-600
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-6 flex flex-col gap-5">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold text-white">Your Financials</h2>
              <p className="text-slate-400 text-sm">Enter income, expenses &amp; loan terms</p>
            </div>
            <button
              onClick={handleReset}
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-6">
            <div className="flex items-center justify-between mb-5">
              <div>
                <h2 className="text-lg font-bold text-white">Eligibility Results</h2>
            ...
            {results ? (
              <>
                ...
                <div className="bg-gradient-to-r from-indigo-600/20 to-violet-600/20 border border-indigo-500/30 rounded-2xl p-5 mb-4 text-center">
                  ...
                  <p className="text-slate-400 text-sm mt-1">{disp(results.loanAmount)}</p>
                </div>
          ...
          {results && (
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-6">
              <h3 className="text-base font-bold text-white mb-4">Income Analysis</h3>
              <div className="flex flex-col sm:flex-row gap-6 items-center">
                ...
                <div className="flex-1 w-full">
                  ...
                  <div className="mt-2 pt-2 border-t border-white/10 flex justify-between">
                    <span className="text-sm text-slate-400">Eligible EMI <span className="text-violet-400">({foirPct}% of net)</span></span>
          ...
          {results && results.loanAmount > 0 && (
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-6">
              <h3 className="text-base font-bold text-white mb-4">Loan Summary</h3>
              <div className="grid grid-cols-2 gap-3">
                <MetricCard
