    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 dark:from-slate-900 via-slate-100 dark:via-slate-800 to-indigo-100 dark:to-indigo-950 py-10 px-4">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-md dark:shadow-2xl rounded-2xl p-4 mb-6"
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            {/* Input Currency */}
            <div className="flex items-center gap-3">
              <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 whitespace-nowrap">Input Currency</label>
              <select
                ...
                className="px-3 py-2 rounded-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-slate-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
              >
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <button
                onClick={handleReset}
                className="flex items-center gap-1.5 px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:text-white bg-white dark:bg-white/5 hover:bg-white/10 border border-gray-200 dark:border-white/10 rounded-xl transition-all"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mb-6">
            ...
            {loans.map((loan, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        className="bg-transparent border-none text-slate-900 dark:text-white font-bold text-lg focus:outline-none focus:ring-0 w-28"
                        maxLength={20}
                      />
                    </div>
                    {loans.length > 2 && (
                  ...
                  {/* Loan Amount */}
                  <div>
                    <label className="block text-xs font-semibold text-slate-600 dark:text-slate-400 mb-1.5">Loan Amount</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        min={0}
                        className="w-full pl-8 pr-4 py-2.5 rounded-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all text-sm"
                      />
                    </div>
                  </div>
                  ...
                  {/* Interest Rate */}
                  <div>
                    <label className="block text-xs font-semibold text-slate-600 dark:text-slate-400 mb-1.5">Interest Rate (% p.a.)</label>
                    <div className="relative">
                      <input
                        type="number"
                        value={loan.rate}
                        ...
                        max={50}
                        step="0.1"
                        className="w-full pl-4 pr-10 py-2.5 rounded-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all text-sm"
                      />
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      <label className="text-xs font-semibold text-slate-600 dark:text-slate-400">Loan Tenure</label>
                        ...
                        {(['months', 'years'] as const).map(u => (
                          <button
                            ...
                            className={`px-2.5 py-1 text-[11px] rounded-md font-semibold transition-all ${
                              loan.tenureUnit === u ? 'bg-indigo-600 text-white' : 'text-slate-500 hover:text-slate-900 dark:text-white'
                            }`}
                          >
                    ...
                    <div className="relative">
                      <input
                        ...
                        min={1}
                        className="w-full pl-4 pr-16 py-2.5 rounded-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all text-sm"
                      />
                  ...
                  {/* Processing Fee */}
                  <div>
                    <label className="block text-xs font-semibold text-slate-600 dark:text-slate-400 mb-1.5">Processing Fee <span className="text-slate-600">(optional)</span></label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 font-bold text-sm pointer-events-none">{inputSym}</span>
                      <input
                        type="number"
                  ...
                  {results.find(r => r.id === loan.id) && (
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      className={`bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-3 space-y-1`}
                    >
                      <div className="flex justify-between text-xs">
                        <span className="text-slate-500">Monthly EMI</span>
                        <span className="text-slate-900 dark:text-white font-bold">{dispShort(results.find(r => r.id === loan.id)!.emi)}</span>
                      </div>
                      <div className="flex justify-between text-xs">
                      ...
                      <div className="flex justify-between text-xs">
                        ...
                        <span className="text-slate-900 dark:text-white font-bold">{dispShort(results.find(r => r.id === loan.id)!.totalCost)}</span>
                      </div>
          ...
          {loans.length < 5 && (
            <motion.button
              ...
              animate={{ opacity: 1 }}
              onClick={addLoan}
              className="border-2 border-dashed border-gray-200 dark:border-white/10 hover:border-indigo-500/50 rounded-2xl p-8 flex flex-col items-center justify-center gap-3 text-slate-500 hover:text-indigo-400 transition-all group min-h-[300px]"
            >
              <div className="w-14 h-14 rounded-2xl bg-white dark:bg-white/5 group-hover:bg-indigo-500/10 flex items-center justify-center transition-all">
        ...
        {results.length >= 2 && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 }}
            className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-md dark:shadow-2xl rounded-2xl p-6 mb-6"
          >
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold text-slate-900 dark:text-white">Comparison Table</h2>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">Side-by-side analysis</p>
                </div>
              </div>
              {/* Display Currency */}
              <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={`px-2.5 py-1 text-[11px] rounded-full border font-medium transition-all ${
                        selectedResultCurrency === c
                          ...
                          : 'bg-white dark:bg-white/5 border-gray-200 dark:border-white/10 text-slate-500 hover:border-indigo-400 hover:text-slate-700 dark:text-slate-300'
                      }`}
                    >
                      {c}
                    </button>
                      ...
                      >
                        <td className="px-4 py-3.5">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-slate-900 dark:text-white font-semibold">{r.name}</span>
                          </div>
                        </td>
                        <td className="px-4 py-3.5 text-right text-slate-700 dark:text-slate-300">{dispShort(r.principalINR)}</td>
                        <td className="px-4 py-3.5 text-right text-slate-700 dark:text-slate-300">{r.rate}%</td>
                        <td className="px-4 py-3.5 text-right text-slate-700 dark:text-slate-300">{r.months} mo</td>
                        <td className={`px-4 py-3.5 text-right font-bold ${r.isBestEMI ? 'text-emerald-400' : 'text-slate-900 dark:text-white'}`}>
                          {disp(r.emi)}
                        ...
                        <td className="px-4 py-3.5 text-right text-slate-600 dark:text-slate-400">{r.processingFeeINR > 0 ? disp(r.processingFeeINR) : '—'}</td>
                        <td className={`px-4 py-3.5 text-right font-bold ${r.isBestCost ? 'text-emerald-400' : 'text-slate-900 dark:text-white'}`}>
                          {disp(r.totalCost)}
                  ...
                  return (
                    <div key={r.id}>
                      <div className="flex justify-between text-sm mb-1.5">
                        ...
                        <span className={`font-bold ${r.isBestEMI ? 'text-emerald-400' : 'text-slate-700 dark:text-slate-300'}`}>
                          {disp(r.emi)}/mo
                ...
                {results.map((r, i) => {
                  ...
                  return (
                    <div key={r.id}>
                      <div className="flex justify-between text-sm mb-1.5">
                        <span className={`font-semibold ${color.text}`}>{r.name}</span>
                        <span className={`font-bold ${r.isBestCost ? 'text-emerald-400' : 'text-slate-700 dark:text-slate-300'}`}>
        ...
        {insights.length > 0 && (
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-base font-bold text-slate-900 dark:text-white">Smart Insights</h3>
                <p className="text-slate-600 dark:text-slate-400 text-xs">AI-powered analysis of your loan options</p>
              </div>
            </div>
            <div className="space-y-3">
              {insights.map((insight, i) => (
                <motion.div
                  ...
                  className="flex items-start gap-3 px-4 py-3 rounded-xl bg-white dark:bg-white/5 border border-gray-100 dark:border-gray-100 dark:border-white/5"
                >
            ...
            >
              <div className="flex flex-col sm:flex-row items-center gap-6">
                ...
                <div className="text-center sm:text-left flex-1">
                  ...
                  <h3 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-1">{winner.name}</h3>
                ...
                <div className="flex gap-6 text-center">
                  <div>
                    ...
                    <p className="text-2xl font-extrabold text-slate-900 dark:text-white">{dispShort(winner.emi)}</p>
                  </div>
                  <div>
                    <p className="text-xs font-semibold text-emerald-400 uppercase tracking-wider mb-1">Total Cost</p>
                    <p className="text-2xl font-extrabold text-slate-900 dark:text-white">{dispShort(winner.totalCost)}</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <motion.div
          ...
          className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-md dark:shadow-2xl rounded-2xl p-6"
        >
          <p className="text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-3">EMI Formula Used</p>
          <p className="font-mono text-sm text-slate-700 dark:text-slate-300 leading-relaxed mb-3">
