  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-950 py-10 px-4">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* LEFT — INPUTS */}
        <div className="lg:col-span-7 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-6 flex flex-col gap-5">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold text-white">Salary Components</h2>
              <p className="text-slate-400 text-sm">Enter earnings and deductions</p>
            </div>
            <button
              onClick={handleReset}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-300 mb-2">Employee Name (Optional)</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-900/50 border border-white/10 text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
                />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-bold text-indigo-300 uppercase tracking-wider flex items-center gap-2 border-b border-white/10 pb-2">
                <Banknote className="w-4 h-4"/> Earnings
              </h3>
              <div>
                <label className="block text-[13px] text-slate-300 mb-1">Basic Salary</label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">{inputSym}</span>
                  <input type="number" min={0} value={basicSalary} onChange={e => setBasicSalary(e.target.value)} className="w-full pl-8 pr-3 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                </div>
              </div>
              <div>
                <label className="block text-[13px] text-slate-300 mb-1">HRA</label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">{inputSym}</span>
                  <input type="number" min={0} value={hra} onChange={e => setHra(e.target.value)} className="w-full pl-8 pr-3 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[13px] text-slate-300 mb-1">DA</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">{inputSym}</span>
                    <input type="number" min={0} value={da} onChange={e => setDa(e.target.value)} className="w-full pl-8 pr-3 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                  </div>
                </div>
                <div>
                  <label className="block text-[13px] text-slate-300 mb-1">Bonus</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">{inputSym}</span>
                    <input type="number" min={0} value={bonus} onChange={e => setBonus(e.target.value)} className="w-full pl-8 pr-3 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                  </div>
                </div>
              </div>
              <div>
                <label className="block text-[13px] text-slate-300 mb-1">Other Allowances</label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">{inputSym}</span>
                  <input type="number" min={0} value={otherAllowances} onChange={e => setOtherAllowances(e.target.value)} className="w-full pl-8 pr-3 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                </div>
              </div>
            </div>
            ...
            {/* Deductions */}
            <div className="space-y-4">
              <h3 className="text-sm font-bold text-red-300 uppercase tracking-wider flex items-center gap-2 border-b border-white/10 pb-2">
                <MinusCircle className="w-4 h-4"/> Deductions
              </h3>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[13px] text-slate-300 mb-1">PF (%)</label>
                  <div className="relative">
                    <input type="number" min={0} max={100} value={pfPercent} onChange={e => setPfPercent(e.target.value)} className="w-full pl-3 pr-8 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">%</span>
                  </div>
                </div>
                <div>
                  <label className="block text-[13px] text-slate-300 mb-1">Tax (%)</label>
                  <div className="relative">
                    <input type="number" min={0} max={100} value={incomeTaxPercent} onChange={e => setIncomeTaxPercent(e.target.value)} className="w-full pl-3 pr-8 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">%</span>
                  </div>
                </div>
              </div>
              <div>
                <label className="block text-[13px] text-slate-300 mb-1">Insurance</label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">{inputSym}</span>
                  <input type="number" min={0} value={insurance} onChange={e => setInsurance(e.target.value)} className="w-full pl-8 pr-3 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[13px] text-slate-300 mb-1">Prof. Tax</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">{inputSym}</span>
                    <input type="number" min={0} value={professionalTax} onChange={e => setProfessionalTax(e.target.value)} className="w-full pl-8 pr-3 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                  </div>
                </div>
                <div>
                  <label className="block text-[13px] text-slate-300 mb-1">Other</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">{inputSym}</span>
                    <input type="number" min={0} value={otherDeductions} onChange={e => setOtherDeductions(e.target.value)} className="w-full pl-8 pr-3 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 md:col-span-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider flex items-center gap-2 border-b border-white/10 pb-2">
                <Clock className="w-4 h-4"/> Work & Overtime Details
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  <label className="block text-[13px] text-slate-300 mb-1">Working Days</label>
                  <input type="number" min={0} value={workingDays} onChange={e => setWorkingDays(e.target.value)} className="w-full px-3 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                </div>
                <div>
                  <label className="block text-[13px] text-slate-300 mb-1">Overtime Hrs</label>
                  <input type="number" min={0} value={overtimeHours} onChange={e => setOvertimeHours(e.target.value)} className="w-full px-3 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                </div>
                <div>
                  <label className="block text-[13px] text-slate-300 mb-1">OT Rate / Hr</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">{inputSym}</span>
                    <input type="number" min={0} value={overtimeRate} onChange={e => setOvertimeRate(e.target.value)} className="w-full pl-8 pr-3 py-2 rounded-lg bg-slate-900/50 border border-white/10 text-white text-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col flex-1">
                {employeeName && (
                  <div className="mb-3">
                    ...
                    <p className="text-lg text-white font-bold">{employeeName}</p>
                  </div>
                )}
                <div className="bg-gradient-to-r from-emerald-600/20 to-teal-600/20 border border-emerald-500/30 rounded-2xl p-6 mb-4 text-center">
                  ...
                  <p className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight mb-1">{disp(results.netSalary)}</p>
                </div>

                <div className="grid grid-cols-2 gap-3 mb-5">
                  <div className="rounded-xl border bg-slate-800/50 border-white/5 p-4 flex flex-col gap-1">
                    <div className="text-[10px] font-semibold uppercase tracking-wider text-slate-400">Total Gross</div>
                    <p className="font-bold text-lg text-white">{disp(results.grossSalary)}</p>
                  </div>
      ...
      {results && (
        <div className="max-w-7xl mx-auto mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-6">
            <h3 className="text-base font-bold text-white mb-6">Salary Breakdown</h3>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-6 flex flex-col">
            <h3 className="text-base font-bold text-white mb-2">Earnings vs Deductions</h3>
