      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-white dark:bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-gray-200 dark:border-gray-200 dark:border-white/10 shadow-sm dark:shadow-2xl rounded-2xl shadow-2xl p-6 flex flex-col gap-6">
          <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-200 dark:border-white/10 pb-4">
            <div>
              <h2 className="text-lg font-bold text-slate-900 dark:text-slate-900 dark:text-white">Basic Operations</h2>
            </div>
            <button
              onClick={handleReset}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                <label className="block text-[13px] text-slate-700 dark:text-slate-700 dark:text-slate-300 mb-1">Value (X)</label>
              ...
              <div>
                <label className="block text-[13px] text-slate-700 dark:text-slate-700 dark:text-slate-300 mb-1">Total (Y)</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-[13px] text-slate-700 dark:text-slate-700 dark:text-slate-300 mb-1">Percentage (Z)</label>
                <div className="relative">
            ...
            <p className="text-[11px] text-slate-600 dark:text-slate-600 dark:text-slate-400">Edit X, Y, or Z to update all interconnected answers on the right instantly.</p>
          </div>

          <div className="space-y-4 pt-2 border-t border-gray-200 dark:border-gray-200 dark:border-white/10">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-[13px] text-slate-700 dark:text-slate-700 dark:text-slate-300 mb-1">Old Value</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-[13px] text-slate-700 dark:text-slate-700 dark:text-slate-300 mb-1">New Value</label>
                <div className="relative">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-white dark:bg-white dark:bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-gray-200 dark:border-gray-200 dark:border-white/10 shadow-sm dark:shadow-2xl rounded-2xl shadow-2xl p-6 h-full flex flex-col justify-center gap-4">
            ...
            {results && (
              <>
                <div className="border border-gray-200 dark:border-gray-200 dark:border-white/10 bg-gradient-to-r from-blue-900/30 to-indigo-900/30 rounded-xl p-5 shadow-inner">
                  <p className="text-sm text-slate-600 dark:text-slate-600 dark:text-slate-400 mb-1"><span className="text-slate-900 dark:text-slate-900 dark:text-white font-bold">{value}</span> is what % of <span className="text-slate-900 dark:text-slate-900 dark:text-white font-bold">{total}</span>?</p>
                  <p className="text-4xl font-extrabold text-blue-400">{getFormat(results.result1, true)}</p>
                </div>

                <div className="border border-gray-200 dark:border-gray-200 dark:border-white/10 bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-5 shadow-inner">
                  <p className="text-sm text-slate-600 dark:text-slate-600 dark:text-slate-400 mb-1">What is <span className="text-slate-900 dark:text-slate-900 dark:text-white font-bold">{percentage}%</span> of <span className="text-slate-900 dark:text-slate-900 dark:text-white font-bold">{total}</span>?</p>
                  <p className="text-4xl font-extrabold text-slate-900 dark:text-slate-900 dark:text-white">{getFormat(results.result2)}</p>
                </div>

                <div className="border border-gray-200 dark:border-gray-200 dark:border-white/10 bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-5 shadow-inner">
                  <p className="text-sm text-slate-600 dark:text-slate-600 dark:text-slate-400 mb-1"><span className="text-slate-900 dark:text-slate-900 dark:text-white font-bold">{value}</span> is <span className="text-slate-900 dark:text-slate-900 dark:text-white font-bold">{percentage}%</span> of what number?</p>
                  <p className="text-4xl font-extrabold text-slate-900 dark:text-slate-900 dark:text-white">{getFormat(results.result3)}</p>
                </div>
                ...
                <div className={`border ${results.percentChange >= 0 ? 'border-emerald-500/30 bg-emerald-900/10' : 'border-rose-500/30 bg-rose-900/10'} rounded-xl p-5 shadow-inner mt-2`}>
                   <p className="text-sm text-slate-600 dark:text-slate-600 dark:text-slate-400 mb-1">Percentage Change (From <span className="text-slate-900 dark:text-slate-900 dark:text-white font-bold">{oldValue}</span> to <span className="text-slate-900 dark:text-slate-900 dark:text-white font-bold">{newValue}</span>):</p>
