      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="flex-1">
            <h3 className="text-xl md:text-2xl font-bold text-white mb-2 tracking-tight group-hover:text-cyan-300 transition-colors">
              {name}
            </h3>
          ...
          <div className="mt-auto pt-4 border-t border-white/5 flex items-center justify-between text-cyan-400">
